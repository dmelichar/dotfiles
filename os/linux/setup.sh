...
## 1. UPDATE AND UPDATE 2: F

sudo -v

# Fish

curl -O -L -C - https://github.com/fish-shell/fish-shell/releases/download/2.7.1/fish-2.7.1.tar.gz #get tar

#Get asc todo: verify
curl -O -L -C - https://github.com/fish-shell/fish-shell/releases/download/2.7.1/fish-2.7.1.tar.gz.asc


tar xzf fish-2.7.1.tar.gz; rm -rf fish-2.7.1.tar.gz; cd fish-2.7.1; # Extract tar and move into folder

yum install -y ncurses-devel # or apt
